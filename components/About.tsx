    ...
    return (
        <div>
            ...
            <div id="about" className="p-5">
                ...
                {/* Section 2 */}
                <div className=" container flex flex-col-reverse justify-center items-center  gap-8 md:flex-row lg:flex-row md:justify-between lg:justify-between xl:justify-between md:items-center  pt-5 lg:pt-6 pb-16  ">
